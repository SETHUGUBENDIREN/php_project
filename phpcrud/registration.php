            ...
            <form action="registration2.Php" method="post">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-4">
                  ...
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="gen" id="otherGender"
                      value="other" />
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-4 pb-2">
                  ...
                  <div class="form-outline">
                    <input type="number" id="phoneNumber"  name="pno"class="form-control form-control-lg" />
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <select  name="sub"class="select form-control-lg">
                    <option value="1">language</option>
                    <option name="sub">tamil</option>
                    <option name="sub">english</option>
                    <option name="sub" >hindi</option>
                  </select>
